...
COMP_SUP = {
 ...
 "cis":            [("sony", None, "CMOS 图像传感器(独占高端)"), ("samsung_elec", None, "未来替代供应商"), ("viseira", None, "CIS 后段彩色滤光膜(CF)与晶圆级制程（台积电子公司，承接 Sony iPhone CIS 后段）")],
 "lens":           [("largan", None, "手机镜头"), ("genius", None, "镜头/Pancake 光学(Vision Pro)"), ("sunny", None, "镜头"), ("zhaowei", None, "Vision Pro 瞳距(IPD)调节模组独家供应商（微型驱动/齿轮箱，移动光学组件）")],
